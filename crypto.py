...
def frequency_analysis(str):
    """Analyses frequency of letters in a given string."""
    c = Counter(str)
    common = c.most_common(len(str))
    common.sort()
    ...
    for i in common:
        ax.bar(i[0], i[1] / len(str) * 100, width=0.2)
...
if __name__ == '__main__':
    ciphertext = "ESTDTDLGPCJPLDJNTASPCEZMCPLVSZHPGPCTETDLRZZOHLJEZDELCEHZCVTYRHTESNCJAEZLYLWJDTD"
    results = chi_key_search(ciphertext)
